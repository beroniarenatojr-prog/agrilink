...
<div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
    <div>
        ...
        <p class="page-subtitle mb-0"><?= htmlspecialchars($product['name'], ENT_QUOTES, 'UTF-8') ?></p>
    </div>
...
<div class="card shadow-sm">
    <div class="card-body p-4">
        <form method="post" action="<?= url('/farmer/products/update.php') ?>" enctype="multipart/form-data" novalidate>
            <?= csrf_field() ?>
